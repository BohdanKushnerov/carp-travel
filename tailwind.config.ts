  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'gallery-desk': "url('/bcg-images/gallery/bcg-gallery-desk.webp')",
        'contacts-mob': "url('/bcg-images/contacts/bcg-contacts-mob.webp')",
        'contacts-tab': "url('/bcg-images/contacts/bcg-contacts-tab.webp')",
        'contacts-desk': "url('/bcg-images/contacts/bcg-contacts-desk.webp')",
      },
      backgroundColor: {
