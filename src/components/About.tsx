...
const About = () => {
  return (
    <Section className="py-[56px]">
      <div className="md:grid-custom-rows mx-auto w-full max-w-[440px] md:grid md:max-w-[704px] md:grid-cols-2 md:grid-rows-3">
        {/*  */}
        <h2 className="order-1 mb-[8px] text-[40px] font-thin uppercase leading-[140%] tracking-[-0.04em] md:w-[412px] md:text-[67px] md:leading-[100%]">
          WHO <b className="font-medium">WE ARE</b>
        </h2>
        {/* */}
        <div className="order-2 mb-[40px] w-[180px] text-[14px] font-extralight leading-[143%] md:row-span-2 md:mb-[64px] md:ml-auto md:w-[220px] md:text-[16px] md:leading-[125%]">
          <p className="mb-[20px]">
        ...
        {/* */}
        <h3 className="order-3 mb-[40px] ml-auto w-[180px] text-[14px] font-extralight leading-[143%] md:mb-[64px] md:ml-0 md:mt-auto md:w-[221px] md:text-[16px] md:leading-[125%]">
        ...
        {/*  */}
        <p className="order-4 text-[14px] font-extralight leading-[143%] md:col-span-2 md:ml-auto md:max-w-[463px] md:text-[16px] md:leading-[125%]">
