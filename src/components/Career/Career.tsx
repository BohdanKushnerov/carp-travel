...
const Career = () => {
  ...
  return (
    <Section
      className="px-[0px] md:bg-career-tab md:bg-cover md:bg-center md:bg-no-repeat xl:bg-career-desk"
      id={sectionNames.Career}
    >
      <div className="w-full border-none bg-career-mob bg-cover bg-center bg-no-repeat px-[20px] py-[56px] outline-none md:bg-none md:px-0">
        <Container className="md:grid-three-rows-auto md:grid-three-cols-auto xl:grid-two-cols-auto md:grid md:grid-cols-3 md:grid-rows-3 xl:grid-cols-2 xl:grid-rows-[auto_84px_auto]">
